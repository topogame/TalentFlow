  ...
  return (
    <div>
      ...
      <nav className="mb-4 flex items-center gap-2 text-sm text-slate-500">
        <Link href="/processes" className="transition-colors hover:text-indigo-600">Süreçler</Link>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        {!isClosed && (
          <div className="mt-5 flex items-center gap-3 border-t border-slate-100 pt-5">
            ...
            >
              {changingStage ? "Değiştiriliyor..." : "Aşama Değiştir"}
            </button>
          </div>
        )}
        ...
        {showCloseConfirm && (
          <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-4">
            <h3 className="text-sm font-semibold text-amber-800">Süreci Kapat</h3>
            <p className="mt-1 text-sm text-amber-700">
              Bu süreci <strong>{PIPELINE_STAGE_LABELS[newStage]}</strong> olarak kapatmak istediğinizden emin misiniz?
            </p>
            <textarea
              value={stageNote}
            ...
            <div className="mt-3 flex gap-2">
              ...
              >
                {changingStage ? "Kapatılıyor..." : "Onayla"}
              </button>
              <button
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="font-semibold text-slate-900">Aday Bilgileri</h3>
              </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="font-semibold text-slate-900">Pozisyon Bilgileri</h3>
              </div>
              <dl className="space-y-3 text-sm">
                <div className="flex justify-between">
                ...
                {process.position.department && (
                  <div className="flex justify-between">
                    <dt className="text-slate-500">Departman</dt>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm lg:col-span-2">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="font-semibold text-slate-900">Süreç Bilgileri</h3>
              </div>
              <dl className="grid grid-cols-2 gap-4 text-sm sm:grid-cols-4">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-slate-900">{new Date(process.createdAt).toLocaleDateString("tr-TR")}</dd>
                </div>
                <div>
                  <dt className="text-slate-500">Son Güncelleme</dt>
                  <dd className="mt-1 text-slate-900">{new Date(process.updatedAt).toLocaleDateString("tr-TR")}</dd>
                </div>
              </dl>
            </div>
          </div>
          ...
          <div>
            {process.stageHistory.length === 0 ? (
              <div className="rounded-xl border border-slate-200 bg-white py-12 text-center shadow-sm">
                <p className="text-sm text-slate-500">Henüz aşama değişikliği yok</p>
              </div>
            ) : (
          ...
          <div>
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <form onSubmit={handleAddInterview} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      ...
                      <div className="flex items-center gap-3 sm:col-span-2">
                        ...
                        >
                          {savingInterview ? "Kaydediliyor..." : "Kaydet"}
                        </button>
                        <button
                          type="button"
            ...
            {process.interviews.length === 0 ? (
              <div className="rounded-xl border border-slate-200 bg-white py-12 text-center shadow-sm">
                ...
                <p className="mt-3 text-sm text-slate-500">Henüz mülakat planlanmamış</p>
              </div>
            ) : (
              <div className="space-y-3">
                {process.interviews.map((interview) => (
                  <div key={interview.id} className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-slate-900">
                          {new Date(interview.scheduledAt).toLocaleDateString("tr-TR", {
                            day: "2-digit",
                            month: "long",
                            year: "numeric",
                            hour: "2-digit",
                    ...
                    {interview.location && (
                      <p className="mt-2 text-sm text-slate-600">Konum: {interview.location}</p>
                    )}
                    {interview.clientParticipants && (
                      <p className="mt-1 text-sm text-slate-500">Katılımcılar: {interview.clientParticipants}</p>
                    )}
                    {interview.notes && (
          ...
          <div>
            ...
            {process.notes.length === 0 ? (
              <div className="rounded-xl border border-slate-200 bg-white py-12 text-center shadow-sm">
                ...
                <p className="mt-3 text-sm text-slate-500">Henüz not eklenmemiş</p>
              </div>
            ) : (
              <div className="space-y-3">
