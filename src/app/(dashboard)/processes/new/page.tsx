  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Yeni Süreç</h1>
          <p className="mt-0.5 text-sm text-slate-500">Yeni bir işe alım süreci başlatın</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-5 flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-slate-900">Aday Seçimi</h2>
          </div>
            ...
            <div ref={candidateRef} className="relative">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Aday adı ile arayın..."
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-5 flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-slate-900">Firma ve Pozisyon</h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            {/* Position select */}
            <div>
              <label className="block text-sm font-medium text-slate-700">Pozisyon</label>
              {!selectedFirm ? (
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-5 flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-slate-900">Uyum Değerlendirmesi</h2>
          </div>

          <div>
            <label className="block text-sm font-medium text-slate-700">Uyum Puanı (isteğe bağlı)</label>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {saving ? "Kaydediliyor..." : "Süreç Başlat"}
          </button>
          <button
            type="button"
            onClick={() => router.back()}
